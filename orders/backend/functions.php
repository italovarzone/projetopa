...
function bodyhomepage($title) {
    ...
    <body>
        <div class=\"container\">
            ...
            <h1>Recycle Memory</h1>
            <input type=\"submit\" value=\"Fazer Login\" class=\"homebuttons\">
            <input type=\"submit\" value=\"Cadastra-se\" class=\"homebuttons\">
        </div>
    </body>
    </html>";
}
